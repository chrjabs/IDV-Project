...
```
cd existing_repo
git remote add origin https://gitlab.com/BifbofII/idv-project.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/BifbofII/idv-project/-/settings/integrations)
